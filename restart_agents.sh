...
PHEDEX_x509_USER_PROXY=var/lib/vobox/cms/proxy_repository/+2fDC+3dch+2fDC+3dcern+2fOU+3dOrganic+20Units+2fOU+3dUsers+2fCN+3ddchasque+2fCN+3d826698+2fCN+3dDiogo+20BASTOS+2fCN+3dproxy-voms+20cms
